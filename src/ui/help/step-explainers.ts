...
export interface StepExplainer {
  ...
  sensitivity: string;
  /**
   * Phase 10.3 — what this step DOES NOT model. Each entry should be
   * actionable for a sceptical reviewer ("if your engagement has X, the
   * engine won't catch it"), not a vague disclaimer.
   */
